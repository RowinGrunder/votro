...
const MusicDetail = ({ item }) => {
  return (
    <div className="m-5 lowercase space-y-1 w-2/3">
      ...
      <button className="absolute right-3 top-2 h-20 border border-gray-200 flex flex-col items-center justify-center px-5 space-y-2 hover:bg-gray-50 bg-white">
        <span>
